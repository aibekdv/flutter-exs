...
class ChangeScreenAnimation {
  ...
  static final List<AnimationController> homeControllers = [];
  static final List<Animation<Offset>> homeAnimations = [];
